...
public class bilmece extends AppCompatActivity implements View.OnClickListener {
    ...
    void finishQuiz(){
        ...
        if(score >= totalQuestion*0.60){
            ...
            passStatus="Biraz daha çalışmalısın";
        }

        new AlertDialog.Builder(this)
                .setTitle(passStatus)
                .setMessage("Skor "+score+" out of "+totalQuestion)
                .setMessage("Toplam "+totalQuestion+" soruda "+score+" soru bildin.")
                .setPositiveButton("Yeniden Başla",(dialogInterface, i) -> restartQuiz() )
                .setCancelable(false)
                .show();
    }
